...
\section{Input Commands}
    ...
    \item 2 - visualise surface normals (usefull for debugging and verifying smoothed normals)
    \end{enumerate}
...
\includegraphics[width=0.5\textwidth]{img/g1}
\includegraphics[width=0.5\textwidth]{img/g3}
\includegraphics[width=0.5\textwidth]{img/g4}
\includegraphics[width=0.5\textwidth]{img/g10}
