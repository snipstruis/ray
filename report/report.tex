...
\includegraphics[width=\textwidth]{img/classic}
...
\includegraphics[width=\textwidth]{img/earlyTeapot}
...
\includegraphics[width=\textwidth]{img/ground}
\includegraphics[width=\textwidth]{img/hiresTeapot}
\includegraphics[width=\textwidth]{img/niceSphere}
\includegraphics[width=\textwidth]{img/pumpkin}
\includegraphics[width=\textwidth]{img/refractingTeapot}
\includegraphics[width=\textwidth]{img/simpleTree}
\includegraphics[width=\textwidth]{img/smoothTeapot1}
\includegraphics[width=\textwidth]{img/smoothTeapot2}
\includegraphics[width=\textwidth]{img/solidTeapot}
\includegraphics[width=\textwidth]{img/teddy}
\includegraphics[width=\textwidth]{img/treeSpheres}
